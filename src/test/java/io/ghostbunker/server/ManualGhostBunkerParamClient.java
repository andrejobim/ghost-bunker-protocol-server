...
public class ManualGhostBunkerParamClient {
    ...
    private static final String NICKNAME = "Andre-A";
    private static final String ROOM_ID = "sala1";

    private static final boolean SEND_MESSAGE_AFTER_JOIN = false;
    ...
    public static void main(String[] args) throws Exception {
        ...
        ManualGhostBunkerParamClient client = new ManualGhostBunkerParamClient();
        client.start();
    }
